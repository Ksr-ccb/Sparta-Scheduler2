...
public class ApiExceptionHandler {
    ...
    /**
     * [예외] 비밀번호 인증에 실패하거나 유효하지 않은 값을 직젋 throw 했을 때 작동 ResponseStatusException 처리 (400, 401, 404 등)
     */
     ...
     */
     @ExceptionHandler(Exception.class) public ResponseEntity<Map<String, String>> handleGlobalException(Exception ex) {
